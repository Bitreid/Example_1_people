...
*/
  ...
  // создаем экземпляр класса и массив данных все записей
...
?>
   ...
   <table class='table table-bordered table-sm'>
     <thead>
      <tr>
        <td><h4>Форматирование мужчин и по возрасту до и после 20лет</h4></td>
        <td class="smal_male_td">До</td>
        <td class="male_td">После</td>
      </tr>
    </thead>
      <tr>
        <td><h4>Форматирование женщин и по возрасту до и после 20лет</h4></td>
